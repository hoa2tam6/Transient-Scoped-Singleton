...
namespace TransientScopedSingleton.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //Check Change
            ViewBag.TransientIsChange = ViewBag.transient1 != ViewBag.transient2;
            ViewBag.ScopedIsChange = ViewBag.scoped1 != ViewBag.scoped2;
            ViewBag.SingletonIsChange = ViewBag.singleton1 != ViewBag.singleton2;
